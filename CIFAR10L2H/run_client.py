...
parser.add_argument('--thresholds', type=str, default='0.3275')  # comma-separated
...
if __name__ == "__main__":
    ...
    thresholds = [0.3275]#[float(x) for x in args.thresholds.split(',')] if args.thresholds else [0.0]
    iterations = 5
    client_cps = 0.0
